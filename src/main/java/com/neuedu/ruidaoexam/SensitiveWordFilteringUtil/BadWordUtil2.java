package com.neuedu.ruidaoexam.SensitiveWordFilteringUtil;
...
public class BadWordUtil2 {
	//public static String filePath = System.getProperty("user.dir")+"\\src\\com\\neu\\ruidaoQA\\SensitiveWordFilteringUtil\\dictionary.txt";//敏感词库文件路径
	public static String filePath = "C:\\myEclipseProjects\\RuiDaoExam\\src\\main\\java\\com\\neuedu\\ruidaoexam\\SensitiveWordFilteringUtil\\dictionary.txt";//敏感词库文件路径
	...
	/**
	 * TODO 将我们的敏感词库构建成了一个类似于一颗一颗的树，这样我们判断一个词是否为敏感词时就大大减少了检索的匹配范围。
